                ...
                <div id="email-header-tools">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a id="read" href="#" v-on:click="read()">خوانده شده</a></li>
                            <li><a id="unread" href="#" v-on:click="unread()">نخوانده</a></li>
                        </ul>
                    </div>
                    <div class="btn-group">
                        ...
                        <button id="delete" class="btn btn-primary" type="button" title="پاک کردن" data-toggle="tooltip"
                                data-placement="bottom" v-on:click="deleteMessage()">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li id="important">
                                <a href="#" @click="label('important')"><i class="fa fa-circle"
                                                                           style="color: #0080c0"></i> مهم</a>
                            </li>
                            <li id="work">
                                <a href="#" @click="label('work')"><i class="fa fa-circle green"></i>کاری</a>
                            </li>
                            <li id="personal">
                                <a href="#" @click="label('personal')"><i class="fa fa-circle red"></i> شخصی</a>
                            </li>
                            <li id="document" @click="label('document')">
                ...
                @foreach($messages as $message)
                    <li class="{{$message->is_read ? '' : 'unread'}} clickable-row" id="mail-{{$message->id}}"
                        ...
                        <div id="{{$message->id}}" class="star">
                            <a {{$message->isStar()}} v-on:click="star({{ $message->id }})"></a>
                        </div>
                        <div class="name">
                            {{$message->user ? $message->user->name : 'کاربر حذف شده'}}
                        </div>
                        <div class="message">
                            {{$message->labels()}}
