        ...
        <div class="col-lg-12">
            ...
            <header id="email-header" class="clearfix">
                ...
                <div id="email-header-tools">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-primary" id="refresh" type="button" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="تازه کردن">
                            <i class="fa fa-refresh"></i>
                        </button>
                        <button class="btn btn-primary" id="spam" type="button" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="اسپم">
                            <i class="fa fa-exclamation-circle"></i>
                        </button>
                        <button class="btn btn-primary" id="drop" type="button" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="حذف">
                            <i class="fa fa-trash-o"></i>
                        </button>
                        <button class="btn btn-primary" id="undo" type="button" title="" data-toggle="tooltip" data-placement="bottom" data-original-title=" بازگردانی حذف">
...
@foreach($messages as $message)
                    <li class="{{$message->is_read ? '' : 'unread'}} clickable-row" id="mail-{{$message->id}}" data-href="{{route('home.show', $message->id)}}">
                        ...
                        <div class="meta-info">
                            ...
                            <span class="date">{{Verta::instance($message->created_at)}}</span>
                        </div>
                    </li>
@endforeach
            </ul>
        ...
        <div class="nano-pane" style="display: none;"><div class="nano-slider" style="height: 230px; transform: translate(0px, 0px);"></div></div></div>
